...
= 2.7.0 =
* В настройки плагина добавлена возможность включить запрос согласия пользователя с политикой конфиденциальности сайта перед регистрацией.
* Понижен приоритет использования функции CURL, тем самым исправлено значительное количество ошибок "Не удалось получить данные пользователя."
* Добавлен хук ulogin_get_user_data, который вызывается перед авторизацией пользователя и в который передается массив данных пользователя, полученный от ulogin.ru. Это позволяет реализовать, по ссвоему усмотрению, любые дополнительные обработки или сохранение этих данных.
* В хук ulogin_enter_user добавлен вторым аргументом массив данных пользователя.
